...
<body>
<header>
<div class="lAlign" id="hImg"><img src="<?= base_url() ?>resources/images/raptr.png" height="40" width="67"/></div>
<div class="hBlock rAlign"><span id="admName"><?= $user_name ?></span><span id="mAction"><a href="<?= base_url() ?>home/logout">Log Out</a></span></div>
</header>
